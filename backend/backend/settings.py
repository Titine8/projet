...
SECRET_KEY = 'django-insecure-ai(0uo+le(mxhpfe)_mycc*q04ftcnz*5oj6yg&*0tqfcm01w_'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'projet',        # Nom de ta base créée dans phpMyAdmin
        'USER': 'root',
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(days=1),      # 1 jour pour refresh
